              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', flex: 1 }}>
                ...
                {matchScore !== null && (
                  <motion.div
                    ...
                    style={{ marginTop: 'auto', paddingTop: '1.5rem', borderTop: '1px solid rgba(255,255,255,0.1)' }}
                  >
                    ...
                    {(() => {
                      ...
                      if (matchScore >= 70) { label = '✅ Strong Match — Likely Accepted'; bg = '#dcfce7'; color = '#15803d'; }
                      else if (matchScore >= 40) { label = '⚠️ Partial Match — May be Reviewed'; bg = '#fef9c3'; color = '#92400e'; }
                      else { label = '❌ Weak Match — Likely Rejected'; bg = '#fee2e2'; color = '#dc2626'; }
                      return (
                        <div style={{ background: bg, color, padding: '0.85rem 1.25rem', borderRadius: '0.75rem', fontWeight: '700', fontSize: '0.95rem', textAlign: 'center' }}>
                          {label}
                        </div>
                      );
                    })()}
